  ...
  const expandedRowRender = (record) => {
      ...
      },
      {
        ...
        render: (_, koiRecord) => (
          <>
            ...
            <Button
              type="default"
              onClick={() => handleSendToDelivery(record.key, koiRecord.koi)} // Pass both tripKey and koiKey
              disabled={koiRecord.status !== "Paid"}
            >
              Send to Delivery
            </Button>
    ...
    return (
      <Table
        ...
        pagination={false}
        rowKey={(row) => row.koi} // Use Koi name as rowKey for uniqueness
      />
    );
  };
